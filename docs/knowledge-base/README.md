...
| 生活助手 / Life Console / 2.8.0（iOS 浮动底部导航） | [版本知识库](生活助手-LifeConsole-2.8.0/README.md) | [PRD（Gate 1 已确认）](生活助手-LifeConsole-2.8.0/生活助手-LifeConsole-2.8.0.md) | [设计（Gate 2 已确认）](生活助手-LifeConsole-2.8.0/设计方案-生活助手-LifeConsole-2.8.0.md) / [技术（Gate 2 已确认）](生活助手-LifeConsole-2.8.0/技术方案-生活助手-LifeConsole-2.8.0.md) / [测试计划（本地与 CI 已通过）](生活助手-LifeConsole-2.8.0/测试计划-生活助手-LifeConsole-2.8.0.md) | [项目管理](生活助手-LifeConsole-2.8.0/项目管理-生活助手-LifeConsole-2.8.0.md) | 待验收（待开始） | Draft PR [#84](https://github.com/Matthew-1996/life-assistant/pull/84)；实现候选、完整本地回归与 node / python / privacy CI 已通过；尚未授权 Preview、合并或 Production |
