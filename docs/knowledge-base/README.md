...
| 生活助手 / Life Console / 2.5.0（界面与效率优化） | [版本知识库](生活助手-LifeConsole-2.5.0/README.md) | [PRD（Gate 1 已确认；新闻可靠性补充已批准）](生活助手-LifeConsole-2.5.0/生活助手-LifeConsole-2.5.0.md) | [设计（Gate 2 v2 已确认）](生活助手-LifeConsole-2.5.0/设计方案-生活助手-LifeConsole-2.5.0.md) / [技术（Owner 认证生命周期统一已实现）](生活助手-LifeConsole-2.5.0/技术方案-生活助手-LifeConsole-2.5.0.md) / [工程验收（Draft PR #65 Preview 已完成）](生活助手-LifeConsole-2.5.0/工程评审与验收-生活助手-LifeConsole-2.5.0.md) | [项目管理（Draft PR #65）](生活助手-LifeConsole-2.5.0/项目管理-生活助手-LifeConsole-2.5.0.md) | 已上线；快速维护中 | PR #63/#64 已发布；Owner API 当日摘要成功但浏览器未请求，Draft PR #65 全量门禁与纯静态 Preview 已完成，等待独立验收与 Production 门禁 |
