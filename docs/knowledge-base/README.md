...
| 生活助手 / Life Console / 2.5.0（界面与效率优化） | [版本知识库](生活助手-LifeConsole-2.5.0/README.md) | [PRD（Gate 1 已确认；新闻可靠性补充已批准）](生活助手-LifeConsole-2.5.0/生活助手-LifeConsole-2.5.0.md) | [设计（Gate 2 v2 已确认）](生活助手-LifeConsole-2.5.0/设计方案-生活助手-LifeConsole-2.5.0.md) / [技术（新闻可靠性补充已批准）](生活助手-LifeConsole-2.5.0/技术方案-生活助手-LifeConsole-2.5.0.md) / [工程验收（既有 Production 已发布）](生活助手-LifeConsole-2.5.0/工程评审与验收-生活助手-LifeConsole-2.5.0.md) | [项目管理（Draft PR #63）](生活助手-LifeConsole-2.5.0/项目管理-生活助手-LifeConsole-2.5.0.md) | 已上线；快速维护中 | 既有 2.5.0 已上线；GDELT 失败时切换新华网/BBC、保存 7 天去敏 Cron 运行记录的补强已获 PO 确认，待 TDD、Preview 和独立 Production 门禁 |
