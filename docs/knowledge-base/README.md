...
| 生活助手 / Life Console / 2.5.0（界面与效率优化） | [版本知识库](生活助手-LifeConsole-2.5.0/README.md) | [PRD（Gate 1 已确认）](生活助手-LifeConsole-2.5.0/生活助手-LifeConsole-2.5.0.md) | [设计（Gate 2 v2 已确认）](生活助手-LifeConsole-2.5.0/设计方案-生活助手-LifeConsole-2.5.0.md) / [技术（Gate 2 v2 已确认）](生活助手-LifeConsole-2.5.0/技术方案-生活助手-LifeConsole-2.5.0.md) / [工程验收（合成 Preview 已通过）](生活助手-LifeConsole-2.5.0/工程评审与验收-生活助手-LifeConsole-2.5.0.md) | [项目管理（Draft PR #58）](生活助手-LifeConsole-2.5.0/项目管理-生活助手-LifeConsole-2.5.0.md) | 待验收 | 功能、本地全量门禁与受保护合成 Preview 已完成；Owner Preview、migration、自动化、合并和 Production 仍按独立门禁待确认 |
