...
| 生活助手 / Life Console / 2.1.0（简化备份与恢复） | [版本知识库](生活助手-LifeConsole-2.1.0/README.md) | [PRD（Gate 1 待确认）](生活助手-LifeConsole-2.1.0/生活助手-LifeConsole-2.1.0.md) | 设计、技术与工程验收在对应阶段创建 | [项目管理](生活助手-LifeConsole-2.1.0/项目管理-生活助手-LifeConsole-2.1.0.md) | 待需求评审（进行中） | PO 已提交新方案；D1-D8 与需求评审结论待确认，PR #38 暂不原样合并 |
