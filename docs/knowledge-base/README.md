...
| 生活助手 / Life Console / 2.0.0（云端真相源）| [版本知识库](生活助手-LifeConsole-2.0.0/README.md) | [PRD（Gate 1 已确认）](生活助手-LifeConsole-2.0.0/生活助手-LifeConsole-2.0.0.md) | [设计草稿（含 O1-O4 待评审）](生活助手-LifeConsole-2.0.0/设计方案-生活助手-LifeConsole-2.0.0.md) / [技术草稿（含 Q1-Q4 待评审）](生活助手-LifeConsole-2.0.0/技术方案-生活助手-LifeConsole-2.0.0.md) / [工程验收草稿](生活助手-LifeConsole-2.0.0/工程评审与验收-生活助手-LifeConsole-2.0.0.md) | [项目管理（含 Gate 1 决策日志）](生活助手-LifeConsole-2.0.0/项目管理-生活助手-LifeConsole-2.0.0.md) | 待设计方案评审 & 技术方案评审（Gate 2） | ✅ Gate 1 已通过：2026-08-11 PO 书面签署需求评审报告 §7，授权进入设计 & 技术方案评审；实现代码启动仍需 Gate 2 通过 |
