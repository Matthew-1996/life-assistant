...
| 生活助手 / Life Console / 2.5.0（界面与效率优化） | [版本知识库](生活助手-LifeConsole-2.5.0/README.md) | [PRD（Gate 1 已确认）](生活助手-LifeConsole-2.5.0/生活助手-LifeConsole-2.5.0.md) | [设计（Gate 2 v2 已确认）](生活助手-LifeConsole-2.5.0/设计方案-生活助手-LifeConsole-2.5.0.md) / [技术（Gate 2 v2 已确认）](生活助手-LifeConsole-2.5.0/技术方案-生活助手-LifeConsole-2.5.0.md) / [工程验收（Production 已发布，展示热修复中）](生活助手-LifeConsole-2.5.0/工程评审与验收-生活助手-LifeConsole-2.5.0.md) | [项目管理（PR #58/#59 已合并）](生活助手-LifeConsole-2.5.0/项目管理-生活助手-LifeConsole-2.5.0.md) | 已上线 | 记录页溢出热修复已上线并通过桌面/移动浏览器复验；按 PRD 移除正式站点内部数据治理横幅的快速维护正在独立分支验证 |
