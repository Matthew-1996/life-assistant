...
| 生活助手 / Life Console / 2.6.0（iOS 主屏幕安装） | [版本知识库](生活助手-LifeConsole-2.6.0/README.md) | [PRD（Gate 1 已确认）](生活助手-LifeConsole-2.6.0/生活助手-LifeConsole-2.6.0.md) | [设计（Gate 2 已确认）](生活助手-LifeConsole-2.6.0/设计方案-生活助手-LifeConsole-2.6.0.md) / [技术（Gate 2 已确认）](生活助手-LifeConsole-2.6.0/技术方案-生活助手-LifeConsole-2.6.0.md) / [二次 Preview 验收已通过](生活助手-LifeConsole-2.6.0/工程评审与验收-生活助手-LifeConsole-2.6.0.md) | [项目管理](生活助手-LifeConsole-2.6.0/项目管理-生活助手-LifeConsole-2.6.0.md) | 待验收 | 方案 2、390px 底栏安全区和 Todo 单列修复已通过受保护合成 Preview；Draft PR #77 等待真机复验，未合并或发布 |
