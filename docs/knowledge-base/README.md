...
| 生活助手 / Life Console / 2.8.0（iOS 浮动底部导航） | [版本知识库](生活助手-LifeConsole-2.8.0/README.md) | [PRD（Gate 1 已确认）](生活助手-LifeConsole-2.8.0/生活助手-LifeConsole-2.8.0.md) | [设计（Gate 2 待评审）](生活助手-LifeConsole-2.8.0/设计方案-生活助手-LifeConsole-2.8.0.md) / [技术（Gate 2 待评审）](生活助手-LifeConsole-2.8.0/技术方案-生活助手-LifeConsole-2.8.0.md) / [测试计划草案](生活助手-LifeConsole-2.8.0/测试计划-生活助手-LifeConsole-2.8.0.md) | [项目管理](生活助手-LifeConsole-2.8.0/项目管理-生活助手-LifeConsole-2.8.0.md) | 待设计方案评审（进行中） | Docs-only Draft PR [#84](https://github.com/Matthew-1996/life-assistant/pull/84)；PO 已选择方案 2，接受 PWA 近似材质并明确不做滚动自动收起；尚未授权实现、Preview、合并或 Production |
