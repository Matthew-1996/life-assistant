...
| 生活助手 / Life Console / 2.8.0（iOS 浮动底部导航） | [版本知识库](生活助手-LifeConsole-2.8.0/README.md) | [PRD（Gate 1 已确认）](生活助手-LifeConsole-2.8.0/生活助手-LifeConsole-2.8.0.md) | [设计（Gate 2 已确认）](生活助手-LifeConsole-2.8.0/设计方案-生活助手-LifeConsole-2.8.0.md) / [技术（Gate 2 已确认）](生活助手-LifeConsole-2.8.0/技术方案-生活助手-LifeConsole-2.8.0.md) / [测试计划（本地、CI 与 Preview 技术验收已通过）](生活助手-LifeConsole-2.8.0/测试计划-生活助手-LifeConsole-2.8.0.md) / [工程验收](生活助手-LifeConsole-2.8.0/工程评审与验收-生活助手-LifeConsole-2.8.0.md) | [项目管理](生活助手-LifeConsole-2.8.0/项目管理-生活助手-LifeConsole-2.8.0.md) | 待验收（进行中） | Draft PR [#84](https://github.com/Matthew-1996/life-assistant/pull/84)；[受保护的合成数据 Preview](https://life-console-production-lbvbo3rna-test11-b88a.vercel.app) 已就绪并通过技术验收，等待 PO 产品验收；未授权合并或 Production |
