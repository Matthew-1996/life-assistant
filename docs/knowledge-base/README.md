...
| 生活助手 / Life Console / 2.4.0（统一日记整理） | [版本知识库](生活助手-LifeConsole-2.4.0/README.md) | [PRD draft.1（Gate 1 已确认）](生活助手-LifeConsole-2.4.0/生活助手-LifeConsole-2.4.0.md) | [设计 draft.1](生活助手-LifeConsole-2.4.0/设计方案-生活助手-LifeConsole-2.4.0.md) / [技术 draft.1](生活助手-LifeConsole-2.4.0/技术方案-生活助手-LifeConsole-2.4.0.md) / [工程验收](生活助手-LifeConsole-2.4.0/工程评审与验收-生活助手-LifeConsole-2.4.0.md) | [项目管理](生活助手-LifeConsole-2.4.0/项目管理-生活助手-LifeConsole-2.4.0.md) | 已上线 | PO 已确认统一契约、原文先保存、Agent 优先、DeepSeek 兜底和历史不批量重写；Production 已部署，真实日记质量 POC 与 PR 合并仍未执行 |
