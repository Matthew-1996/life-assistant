...
| 生活助手 / Life Console / 2.1.0（简化备份与恢复） | [版本知识库](生活助手-LifeConsole-2.1.0/README.md) | [PRD（Gate 1 / 2B / 2C 已确认）](生活助手-LifeConsole-2.1.0/生活助手-LifeConsole-2.1.0.md) | [设计（Gate 2C 已确认）](生活助手-LifeConsole-2.1.0/设计方案-生活助手-LifeConsole-2.1.0.md) / [技术（Gate 2C 已确认）](生活助手-LifeConsole-2.1.0/技术方案-生活助手-LifeConsole-2.1.0.md) / [工程验收（Gate 2C 本地通过）](生活助手-LifeConsole-2.1.0/工程评审与验收-生活助手-LifeConsole-2.1.0.md) | [项目管理](生活助手-LifeConsole-2.1.0/项目管理-生活助手-LifeConsole-2.1.0.md) | 开发与联调（Gate 2C 前端减法本地完成；平台 POC 仍阻塞） | PO 已确认网站只保留 iCloud 最新备份并由 Agent 协助未来恢复；正式部署、真实数据、Supabase 后端、正式 Sites、切源与 PR 合并仍需独立门禁；PR #39 为唯一活动分支 |
