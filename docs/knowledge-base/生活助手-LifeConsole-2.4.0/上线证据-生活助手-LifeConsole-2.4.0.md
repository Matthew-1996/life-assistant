...
本文件只记录去敏门禁结果，不包含凭据、日记 ID、原文、哈希、revision、人物资料、模型正文或供应商响应体。
...
| Production 部署 | Vercel deployment `dpl_7QhDZs7ERx9MAEWqwsyBQECmHnp1` 为 `READY / PROMOTED`；正式 alias 指向上述 merge commit |
