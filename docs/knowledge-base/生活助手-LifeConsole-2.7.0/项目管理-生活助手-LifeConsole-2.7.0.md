...
- 主阶段：验收。
- 子状态：整行点击交互修复已完成本地验证、独立复审与 Draft PR CI，等待替换 Preview 授权。
- 范围：Todo 状态展示筛选，仅前端。
...
| Draft PR | completed | PR #79 已更新至 `5463d37`，node、python、privacy 三项 CI 通过 |
...
1. 取得 PO 当次授权后生成替换 Preview，再进行真实浏览器与产品验收。
