...
状态：PO 已确认将原三按钮方案细化为紧凑浮层，并确认整行均可点击；本地完整门禁、独立复审、Draft PR CI、替换 Preview 技术验收、390px 真实浏览器验收与 PO 产品验收均通过。合并与 Production 未授权。
...
PO 于 2026-08-29 确认最新替换 Preview 产品验收通过。PR 合并与 Production 继续保持独立门禁，当前确认不构成二者授权。
